...
#     executable gets (assets/icon/swiftemacs.icon, compiled by the icon step below);
...
# Icon: assets/icon/swiftemacs.icon, generated by dev/gen-icon.py; the actool/.icon step
...
if [ -d "$ICONPKG" ]; then
    ...
    echo "no assets/icon/swiftemacs.icon: bundle carries no icon (run dev/gen-icon.py)"
fi
